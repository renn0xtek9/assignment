...
To exchange data with the OdometryApp, the IMU driver shall stor data in a shared memory queue (\linkreq{7}).\\
...
\hline
The IMU message queue has reached max size & the mitigation consist in notifying with a counter of dropped message (\linkreq{TS5},\linkreq{TS6}). \\
\hline
